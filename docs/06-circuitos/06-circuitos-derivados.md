...
![Esquema 1. a) Disposición típica de tomacorrientes en un recinto donde la  longitud de las ventanas es menor a 3,6 m y la misma llega a nivel del piso. Si la distancia d2 < 1,8m el tomacorriente Tx se elimina y solo se mantiene el tomacorriente Ty.](./fig-03-a.jpg)

![Esquema 1. b) Disposición típica de los tomacorrientes en un recinto donde la longitud de las ventanas es mayor a 3,6 m y la misma llega a nivel del piso. Ver esquema 1.c)](./fig-03-b.jpg)

<!-- página 5 -->



![Esquema 1.c) En el caso de que la longitud de la ventana es mayor a 3,6 m, además la misma llega a nivel del piso, la salida de los tomacorrientes se debe colocar a una distancia no mayor a 0.2 m.](./fig-03-c.jpg)

![Esquema 1.d) En el caso de que la ventana no llegue a nivel del piso (altura mayor o igual a 0,5 m), la separación de los tomacorientes no debe ser mayor a 3,60 m.](./fig-03-d.jpg)
